<template>
  <div class="gia-home">
        ...
        <v-row align="center">
          ...
          <v-col cols="12" md="6">
            <div class="about-content">
              ...
              <p class="about-text">
                Global Information Academy（GIA）は、<br>
                私たちは「人の力を引き出す」を合言葉に、<br>
                システム開発と心理学・脳科学の知見を融合させ、<br>
                仕組みと人の成長の両面からビジネスを支えるDXパートナーです。
              </p>
              <p class="about-text">
                単なる仕組みづくりではなく、経営者や現場の声に寄り添い、<br>
                人の力が最大限に活きる環境をともに築きます。<br>
                技術と心理学の両面から、お客様のビジネスを次のステージへ導きます。
              </p>
    ...
    <section class="works-section" id="works">
      ...
      <v-spacer style="height: 88px;px"></v-spacer>
      <!-- 波形は現状維持 -->
      <div class="section-divider">
        <svg viewBox="0 0 1440 120" preserveAspectRatio="none">
...
const works = [
  ...
  },
  {
    ...
    summary:
      '上場企業もクライアントにもつ会社だったが、社内データが分散。顧客管理・営業管理を統合し、仕組みで人材育成ができるようにサポート。',
  ...
  },
  {
    ...
    summary:
      'AI活用だけでなく、経営の効率化・見える化・役割設計など"仕組み化"を中心に伴走。現場の知見が活きる運営体制へ。',
...
/* .hero-background {
  ...
  /* background-image: 
    ...
    radial-gradient(circle at 70% 60%, rgba(30, 41, 59, 0.8) 0%, transparent 70%);
} */
...
.hero-overlay {
  ...
  /* background: rgba(255, 255, 255, 0.35); 白動画なら薄いグレーのフィルター */
...
.hero-overlay {
  background: rgba(255, 255, 255, 0.35); /* 白系オーバーレイ */
}
